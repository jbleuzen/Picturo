...
class Picturo {
  ...
  public function __construct() {
    ...
    if($settings['private'] && $request_url == "/login") {
       if($_SERVER['REQUEST_METHOD'] == "GET") {
          $this->render_view($settings, 'login.html', array());
          exit;
       }
       ...
       if(isset($postUsername) && isset($postPassword)) {
          ...
          $this->render_view($settings, 'login.html', $twig_vars);
          exit;
       }
    }
    ...
    $this->render_view($settings, 'index.html', $twig_vars);
    exit;
  }
  ...
  private function render_view($settings, $name, $twig_vars) {
     ...
     $output = $twig->render($name, $twig_vars);
     echo $output;
  }
